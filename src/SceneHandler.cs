...
public partial class LessFlashingLights
{
    ...
    private void OnSceneChange(Scene oldScene, Scene newScene)
    {
        ...
        {
            case "Crossroads_ShamanTemple" when Gs.RemoveMajorItemPickupsFlashes:
                GameManager.instance.StartCoroutine(RemoveAncestralMoundFlashes());
                break;
                
            case "Room_Fungus_Shaman" when Gs.RemoveMajorItemPickupsFlashes:
                GameManager.instance.StartCoroutine(RemoveOvergrownMoundFlashes());
                break;
                
            case "Ruins1_24" when Gs.RemoveMajorItemPickupsFlashes:
                GameManager.instance.StartCoroutine(RemoveRealQuakeFlashes());
                break;
                
            case "Dream_Abyss" when Gs.ToneDownBirthPlaceFlashes:
                GameManager.instance.StartCoroutine(RemoveBirthPlaceCutsceneFlashes());
                break;
                
            case "Abyss_15" when Gs.ToneDownBirthPlaceFlashes:
                GameManager.instance.StartCoroutine(RemoveBirthPlaceTriggerFlashes());
                break;
                
            case "Cliffs_06" when Gs.ToneDownGrimmLanternActivation://grimm lantern
                GameManager.instance.StartCoroutine(RemoveGrimmLanternFlashes());
                break;
        
            case "Fungus3_archive_02" when Gs.RemoveDreamerCutsceneFlashes:
                GameManager.instance.StartCoroutine(RemoveQuirrelArchivesCutsceneFlashes());
                break;
        
            case "GG_Hollow_Knight"://PV got lucky enough to have their own transition flashes on top of the rest
                GameManager.instance.StartCoroutine(RemovePVFlashes());
                break;
        
            case "Abyss_21" when Gs.RemoveMajorItemPickupsFlashes:
                GameManager.instance.StartCoroutine(RemoveWingsPickupFlashes());
                break;
                
            case "RestingGrounds_07" when Gs.RemoveMajorItemPickupsFlashes:
                GameManager.instance.StartCoroutine(RemoveDreamNailUpgradeFlashes());
                break;
        
            case "Waterways_13" when Gs.RemoveMajorItemPickupsFlashes:
                GameManager.instance.StartCoroutine(RemoveIsmaObtentionFlashes());
                break;
                
            case "Dream_Nailcollection" when Gs.RemoveMajorItemPickupsFlashes:
                GameManager.instance.StartCoroutine(RemoveDreamNailPickupFlashes());
                break;
        
            case "Grimm_Main_Tent" when Gs.ToneDownGrimmKinFights:
            ...
            case "RestingGrounds_04" when Gs.RemoveDreamerCutsceneFlashes:
            ...
            case "Dream_Final_boss" when Gs.ToneDownRadianceFightsFlashes:
    ...
    private static IEnumerator RemoveAncestralMoundFlashes()
    {
